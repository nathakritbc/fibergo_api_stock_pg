...
type User struct {
	...
	U_email    string `gorm:"size:100;unique"  json:"u_email" form:"u_email" validate:"required,email,max=100"`
	U_password string `json:"u_password" form:"u_password" validate:"required"`
}
